			...
			newNews: [
				{
					...
					preview:
						'В городе появились танцующие роботы на пешеходных переходах. Очевидцы рассказывают о неожиданных дуэлях роботов и веселых танцевальных батлах, ставших новым трендом городского развлечения.',
					description:
				...
				},
				{
					...
					preview:
						'В зоопарке города произошло невероятное событие - обезьяны объединились, чтобы создать тайное общество, посвященное исследованию человеческого образа жизни.',
					description:
...
export const Users = createSlice({
	...
	reducers: {
		...
		addEditingNews: (state, { payload }) => {
			...
			if (index !== -1) {
				// Заменяем элемент массива по индексу
